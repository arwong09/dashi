      ...
      <MaxWidthLayout>
        ...
        <div className="w-full bg-white rounded-md shadow-xl px-16 py-14">
          ...
          <form className="space-y-8" onSubmit={onSubmit}>
              ...
              <div className="flex justify-between w-full">
                ...
                <div className="flex items-center justify-end">
                  <div className="text-sm">
                    <Link href="/reset-password" className="transition text-indigo-500 hover:text-indigo-700 focus:outline-none focus:ring-indigo-200/80 focus:ring-4 focus:border-indigo-300 rounded">
            ...
            <div>
              <button disabled={isLoading || !email || !password} type="submit" className="h-12 transition w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-indigo-200/80 focus:ring-4 disabled:bg-indigo-300">
                {isLoading ? <LoadingSpinner /> : 'Sign in'}
              </button>
              <div className="mt-6 ml-2 text-sm flex justify-center w-full text-slate-700">
                Don&apos;t have an account?
                <Link href="/register" className="transition ml-1 text-indigo-500 hover:text-indigo-600 focus:outline-none focus:ring-indigo-200/80 focus:ring-4 focus:border-indigo-300 rounded">
                  Sign up
                </Link>
              </div>
            </div>
