...
export default function Home() {
    return (<HeaderLayout header={<CurrentUserProvider unauthedChildren={<NavBarUnauthed />}>
      ...
      <MaxWidthLayout>
        <>
          <h2 className="text-[2.4rem] leading-none sm:text-[3.7rem] mt-4 sm:mt-12 mb-12 sm:mb-20 text-center" style={{ fontFamily: 'gladine' }}>
            LOST AND
            <br />
            FOUND LABELS
          </h2>
          <div className="relative w-full flex justify-center h-[300px] sm:h-[400px] imessage">
            ...
            <Image objectFit="contain" fill src="/bottle.png" alt="Lost & Found Labels"/>
          </div>
